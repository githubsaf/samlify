    ...
    return {
        ...
        constructMessageSignature: function (octetString, key, passphrase, isBase64, signingAlgorithm) {
            return __awaiter(this, void 0, void 0, function () {
                var pemHeader, pemFooter, pemContents, binaryDerString, str2ab, binaryDer, cryptoKey, octetStringBuffer, signature, signatureBuffer;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            pemHeader = "-----BEGIN PRIVATE KEY-----";
                            pemFooter = "-----END PRIVATE KEY-----";
                            pemContents = key.substring(pemHeader.length, key.length - pemFooter.length - 1);
                            ...
                            return [4 /*yield*/, crypto.subtle.importKey("pkcs8", binaryDer, {
                                    name: "RSASSA-PKCS1-v1_5",
                                    hash: "SHA-256",
                                }, true, ["sign"])];
                        case 1:
                            cryptoKey = _a.sent();
                            octetStringBuffer = Buffer.from(octetString);
                            return [4 /*yield*/, crypto.subtle.sign("RSASSA-PKCS1-v1_5", cryptoKey, octetStringBuffer)];
                        case 2:
                            signature = _a.sent();
                            signatureBuffer = Buffer.from(signature);
                            return [2 /*return*/, isBase64 !== false
